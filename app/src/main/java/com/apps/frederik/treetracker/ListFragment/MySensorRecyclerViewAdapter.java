...
import com.apps.frederik.treetracker.ListFragment.SensorListFragment.OnListFragmentInteractionListener;
...
public class MySensorRecyclerViewAdapter extends RecyclerView.Adapter<MySensorRecyclerViewAdapter.ViewHolder> {
    ...
    public MySensorRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
